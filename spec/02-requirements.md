...
| `R-022` | A held-back transfer set of 10 items, same concepts, different surface, never seen during the six weeks. | This is the actual measurement. Kept out of the treatment content entirely — and now **out of this repository**, which is public: publishing them destroys them exactly as publishing the FCI would. `P-78`. |
