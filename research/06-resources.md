...
| A | Gutierrez de Blume — *Calibrating calibration: a meta-analysis of learning strategy instruction interventions to improve metacognitive monitoring accuracy*, **Journal of Educational Psychology 114(4), 681–700, 2022** (DOI 10.1037/edu0000674) | 56 effect sizes, 7,667 participants, *g* = −.565 [−.639, −.491]. **Larger for adult-only samples** — the age moderator runs against `R-005` |
| A | DiGiacomo & Chen — *Enhancing self-regulatory skills through an intervention embedded in a middle school mathematics curriculum*, **Psychology in the Schools 53(6), 601–616, 2016** | The only in-band study found: grades 6–7, *n*=30, randomised against a delayed-treatment control, calibration accuracy improved. *n*=30 |
| A | Kleider-Tesler, Prior & Katzir — *The role of calibration of comprehension in adolescence: from theory to online training*, **Journal of Cognitive Education and Psychology 18(2), 190–211, 2019** (DOI 10.1891/1945-8959.18.2.190) | Ninety 10th-graders, three sessions, three feedback conditions. **Scaffolded correction beat calibration feedback** — the most actionable finding we have, `P-70` |
...
**Verified to a weaker standard than `P-06` used, and it should be said.** The three sources above are verified at citation level — authors, journal, volume, pages, DOI — from multiple independent listings. Their *results* were read from abstracts and secondary summaries; the full texts are paywalled (403/402 from the publishers). `P-06`'s standard was to read the source. This is not that, and anything load-bearing should be re-verified against the full text before it is relied on. `P-71`.
